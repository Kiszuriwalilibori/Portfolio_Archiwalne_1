$(document).ready(function () {
  var startHoverOnMenu = (function () {
    ...
    x.forEach((element) => {
      element.addEventListener("mouseenter", hover.add);
    });
    x.forEach((element) => {
      element.addEventListener("mouseleave", hover.remove);
    });
    x.forEach((element) => {
      element.addEventListener("touchstart", hover.add);
    });
    x.forEach((element) => {
      element.addEventListener("touchend", hover.remove);
    });
  })();
